...
window.onload = function() {
  ...
  MinecraftAPI.getServerStatus(server_ip, {
	...
	if (err) {
	  status_container.innerHTML = "Ошибка получения статуса <span class='info'>" + server_ip + "</span><br><span class='info' style='color:#ff4545;font-size:.5em;'>" + err
	}
	  ...
	  status_container.innerHTML = "Сервер сейчас <span class='info' style='color:#ff4545'>оффлайн</span>. Последняя проверка: " + (status.last_online/60)
	}
	else {
